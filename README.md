...
```ts
import makeWASocket, { useMultiFileAuthState } from '@zqdevelopers/baileys-pro'
...
```ts
import makeWASocket, { DisconnectReason, useMultiFileAuthState } from '@zqdevelopers/baileys-pro'
...
```ts
import makeWASocket, { useSingleFileAuthState, useMongoFileAuthState } from '@zqdevelopers/baileys-pro'
...
import { makeInMemoryStore, getAggregateVotesInPollMessage } from '@zqdevelopers/baileys-pro'
...
```ts
import makeWASocket, { makeInMemoryStore } from '@zqdevelopers/baileys-pro'
...
import { downloadMediaMessage, getContentType } from '@zqdevelopers/baileys-pro'
